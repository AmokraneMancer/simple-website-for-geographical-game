...
$sqlgetques = "SELECT * FROM questions "; //WHERE categorie = 'capitale'";
...
<head>
	...
	<!--logo-->	
	<link rel="shortcut icon" href="img/logo333.ico" type="image/x-icon" />
	...
	<link href="Profile/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<link href="Profile/vendor/devicons/css/devicons.min.css" rel="stylesheet">
	<link href="Profile/vendor/simple-line-icons/css/simple-line-icons.css" rel="stylesheet">

	<!-- Style -->
	<link href="Profile/css/resume.css" rel="stylesheet">
...
<body id="page-top" onload="setTimeout('RedirectionScript()', 300000);start()" >

	<!--la barre de coté (pour garder le style de la page)-->
	...
	<div class="container-fluid p-0">
		...
		<section class="resume-section p-3 p-lg-5 d-flex flex-column" id="Jouer">
			...
			<div class="card-box" >
				...
				<div class="panel panel-default" id="Qst">
					<div class="panel-body">
						<form name="" method="POST" action="finTest.php">

							<div class="PositionField">
								<fieldset>
									<legend>Essayer le jeu : </legend>
									<fieldset>
										<legend ><input type="checkbox" id="question1" name="question1" onclick="check()" /><label>Question 1 :</label><?php echo $qst[0];?></legend><input type="hidden" name="q1" value="<?php echo $qst[0];?>">
									...
									<fieldset>
										<legend><input type="checkbox" id="question2" name="question2" onclick="check2()" /><label>Question 2 :</label><?php echo $qst[1];?></legend><input type="hidden" name="q2" value="<?php echo $qst[1];?>">
										<div class="LatLon">
									...
									<fieldset>
										<legend><input type="checkbox" id="question3" name="question3" onclick="check3()" /><label>Question 3 :</label><?php echo $qst[2];?></legend><input type="hidden" name="q3" value="<?php echo $qst[2];?>">
										<div class="LatLon">
									...
									<fieldset>
										<legend><input type="checkbox" id="question4" name="question4" onclick="check4()" /><label>Question 4 :</label><?php echo $qst[3];?></legend><input type="hidden" name="q4" value="<?php echo $qst[3];?>">
										<div class="LatLon">
									...
									<fieldset>
										<legend><input type="checkbox" id="question5" name="question5" onclick="check5()" /><label>Question 5 :</label><?php echo $qst[4];?></legend><input type="hidden" name="q5" value="<?php echo $qst[4];?>">
										<div class="LatLon">
									...
									<fieldset>
										<legend><input type="checkbox" id="question6" name="question6" onclick="check6()" /><label>Question 6 :</label><?php echo $qst[5];?></legend><input type="hidden" name="q6" value="<?php echo $qst[5];?>">
										<div class="LatLon">
									...
									<fieldset>
										<legend><input type="checkbox" id="question7" name="question7" onclick="check7()" /><label>Question 7 :</label><?php echo $qst[6];?></legend><input type="hidden" name="q7" value="<?php echo $qst[6];?>">
										<div class="LatLon">
							...
							<div class="boutonsForm">
								...
								<a href="finTest.php"><button type="submit"   class="button button1" name="valider">valider</button></a>
							</div>
	...
	<!-- JavaScript -->
	<script src="Profile/vendor/jquery-easing/jquery.easing.min.js"></script>
	<script src="Profile/js/resume.min.js"></script>
