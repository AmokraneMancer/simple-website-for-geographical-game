...
$sqlgetques = "SELECT * FROM questions WHERE categorie = 'pays' ORDER BY RAND()";
...
<body id="page-top" >
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav">
				<li class="nav-item">
					<a class="nav-link js-scroll-trigger" onMouseOver="playAudio('buttonAudio')" href="Joueur.php">Mon profil</a>
				</li>
				<li class="nav-item">
					<a class="nav-link js-scroll-trigger" onMouseOver="playAudio('buttonAudio')" href="#Jouer">Jeu</a>
				</li>
				...
				<div class="card-box" >
					...
					<div class="panel panel-default" id="QstCapitales">
						<div class="panel-body">
							<form name="" method="POST" action="finPartiePays.php">

								<div class="PositionField">
									<fieldset>
										<legend>Trouver le pays : </legend>
										<fieldset>
											...
											<input type="hidden" name="reponse1" id="reponse1">
											<div class="LatLon">
												...
												<fieldset>
													...
													<input type="hidden" name="reponse2" id="reponse2">
													<div class="LatLon">
												...
												<fieldset>
													...
													<input type="hidden" name="reponse3" id="reponse3">
													<div class="LatLon">
												...
												<fieldset>
													...
													<input type="hidden" name="reponse4" id="reponse4">
													<div class="LatLon">
												...
												<fieldset>
													...
													<input type="hidden" name="reponse5" id="reponse5">
													<div class="LatLon">
												...
												<fieldset>
													...
													<input type="hidden" name="reponse6" id="reponse6">
													<div class="LatLon">
												...
												<fieldset>
													...
													<input type="hidden" name="reponse7" id="reponse7">
													<div class="LatLon">
										...
										<div class="boutonsForm">
											...
											<a href="finPartiePays.php"><button type="submit"   class="button button1" name="valider">valider</button></a>
										</div>
...
var bornes = L.latLngBounds(northWest, southEast);
 	...
 	function isMarkerInsidePolygon(x,y, data) {
 		var inside = false;
 		for (var ii=0;ii<data.length;ii++){
 			for (var i = 0, j = data.length - 1; i < data.length; j = i++) {
 				var xi = data[i].lat, yi = data[i].lng;
 				var xj = data[j].lat, yj = data[j].lng;
 		...
 		if (question1_check==true){
 			...
 			if (premierClic) {
 				<?php
                        ...
                        var latLngs1 =  L.GeoJSON.coordsToLatLngs(data1,1);//.addTo(map);
                        polygon1 = L.polygon(latLngs1);
                        //polygon1.addTo(map);
                        //map.fitBounds(polygon1.getBounds());
                        if(polygon1.getBounds().contains(e.latlng)){
                        		//polygon1.addTo(map);
                        		inside1 = true;
                        	}
                        ...
                        document.getElementById('reponse1').value=inside1;
                    /*console.log(x,y);  */       
                }
                ...
                if (question2_check==true)
                {
                	...
                	if (premierClic2) {
                        ...
                        var latLngs2 =  L.GeoJSON.coordsToLatLngs(data2,1);//.addTo(map);
                        polygon2 = L.polygon(latLngs2);
                        //polygon2.addTo(map);
                        //map.fitBounds(polygon2.getBounds());
                        if(polygon2.getBounds().contains(e.latlng)){
                        		//polygon1.addTo(map);
                        		inside2 = true;
                        		//alert(inside2);
                        	}
                        ...
                        document.getElementById('reponse2').value=inside2;
                        /*console.log(x,y);  */       
                    }    
                    ...
                    if (question3_check==true)
                    {
                        ...
                        var latLngs3 =  L.GeoJSON.coordsToLatLngs(data3,1);//.addTo(map);
                        polygon3 = L.polygon(latLngs3);
                        //polygon3.addTo(map);
                        //map.fitBounds(polygon3.getBounds());
                        if(polygon3.getBounds().contains(e.latlng)){
                        		//polygon1.addTo(map);
                        		inside3 = true;
                        		//alert(inside3);
                        	}
                        ...
                        document.getElementById('reponse3').value=inside3;
                        /*console.log(x,y);  */       
                    }    
                    ...
                    if (question4_check==true)
                    {
                        ...
                        var latLngs4 =  L.GeoJSON.coordsToLatLngs(data4,1);//.addTo(map);
                        polygon4 = L.polygon(latLngs4);
                        //polygon4.addTo(map);
                        //map.fitBounds(polygon4.getBounds());
                        if(polygon4.getBounds().contains(e.latlng)){
                        		//polygon1.addTo(map);
                        		inside4 = true;
                        		//alert(inside4);
                        	}
                        ...
                        document.getElementById('reponse4').value=inside4;
                        /*console.log(x,y);  */       
                    }    
                    ...
                    if (question5_check==true)
                    {
                        ...
                        var latLngs5 =  L.GeoJSON.coordsToLatLngs(data5,1);//.addTo(map);
                        polygon5 = L.polygon(latLngs5);
                        //polygon5.addTo(map);
                        //map.fitBounds(polygon5.getBounds());
                        if(polygon5.getBounds().contains(e.latlng)){
                        		//polygon1.addTo(map);
                        		inside5 = true;
                        		//alert(inside5);
                        	}
                    ...
                    document.getElementById('reponse5').value=inside5;
                    /*console.log(x,y);  */      
                }    
                ...
                if (question6_check==true)
                {
                	...
                	if (premierClic6) {
                        ...
                        var latLngs6 =  L.GeoJSON.coordsToLatLngs(data6,1);//.addTo(map);
                        polygon6 = L.polygon(latLngs6);
                        //polygon6.addTo(map);
                        //map.fitBounds(polygon6.getBounds());
                        if(polygon6.getBounds().contains(e.latlng)){
                        		//polygon1.addTo(map);
                        		inside6 = true;
                        		//alert(inside6);
                        	}
                    ...
                    document.getElementById('reponse6').value=inside6;
                    /*console.log(x,y);  */       
                }    
                ...
                if (question7_check==true)
                {
                	...
                	if (premierClic7) {
                        ...
                        var latLngs7 =  L.GeoJSON.coordsToLatLngs(data7,1);//.addTo(map);
                        polygon7 = L.polygon(latLngs7);
                        //polygon7.addTo(map);
                        //map.fitBounds(polygon7.getBounds());
                        if(polygon7.getBounds().contains(e.latlng)){
                        		//polygon1.addTo(map);
                        		inside7 = true;
                        		//alert(inside7);
                        	}
                    ...
                    document.getElementById('reponse7').value=inside7;
                    /*console.log(x,y);  */       
                }    
